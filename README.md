...
This repository is currently at **Phase 5** of the build plan (SPEC.md §11) — scaffold, Spotify OAuth, admin auth/config, the public song-request form, the public menu, and the admin approval workflow (approve/deny requests, real playlist insertion). See [`CLAUDE.md`](./CLAUDE.md) for what's implemented so far.
