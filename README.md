...
This repository is currently at **Phase 4** of the build plan (SPEC.md §11) — scaffold, Spotify OAuth, admin auth/config, the public song-request form, and the public menu (now playing, request status lookup, playlist view). See [`CLAUDE.md`](./CLAUDE.md) for what's implemented so far.
